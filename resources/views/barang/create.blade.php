...
@section('content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create Barang</h1>
    @if ($errors->any())
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input value="{{ old('nama_barang') }}" name="nama_barang" type="text" class="form-control"
                        ...
                        <input value="{{ old('harga_barang') }}" name="harga_barang" type="text" class="form-control"
